...
Key Features:
    ...
    - temperature=0.1 (consistent with all pipelines for fair comparison)
"""
...
class RawLLMPipeline:
    ...
    def run(self, query: str) -> Dict[str, Any]:
        ...
        try:
            # temperature=0.1 — consistent with pipeline_b and pipeline_c for fair benchmark comparison
